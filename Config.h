...
#define PINMAP                   DDScopeX //    OFF, Choose from: MiniPCB, MiniPCB2, MaxPCB4, MaxESP4, MaxSTM3, FYSETC_E4,   <-Req'd
...
#define AXIS2_LIMIT_MAX                88 //     90, n. Where n=0..90 (degrees.) Maximum allowed Declination or Altitude.     Infreq
